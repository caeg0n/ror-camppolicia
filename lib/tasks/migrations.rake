...
task :migrations do
  ...
  sh('rails db:drop')
  sh('rails db:create')
  ##sh('rails d scaffold citizen_device')
  sh('rails d scaffold central_device')
  sh('rails g scaffold citizen_device device_id:string state:integer nick:string cel:string')
  sh('rails g scaffold central_device device_id:string state:integer')
